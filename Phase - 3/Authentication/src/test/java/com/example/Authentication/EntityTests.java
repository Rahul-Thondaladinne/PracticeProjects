...
public class EntityTests {
	...
	public void getAndSetName() {
		...
		testUser.setName("Rahul");
		assertEquals(testUser.getName(),"Rahul");
	}
	...
	public void getAndSetEmail() {
		...
		testUser.setEmail("Rahul@email.com");
		assertEquals(testUser.getEmail(),"Rahul@email.com");
	}
	...
	public void checkConstructor() {
		User testUser = new User("Rahul","Rahul@email.com","123");
		
		User checkUser = new User();
		checkUser.setName("Rahul");
		checkUser.setEmail("Rahul@email.com");
